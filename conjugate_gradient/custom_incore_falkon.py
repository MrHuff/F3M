...
from conjugate_gradient.custom_conjugate_gradient_falkon import FalkonConjugateGradient_custom
class InCoreFalkon_custom(FalkonBase):
    ...
    def fit(self,
        ...
        with TicToc('Computing Falkon iterations', debug=self.options.debug):
            optim = FalkonConjugateGradient_custom(self.kernel, precond, self.options,
