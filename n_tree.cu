...
//    bool & >()).def("__mul__",&FFM_object<float,3>::operator*,py::is_operator());
  ...
  * */
    ...
    m.def("rbf float 5", &rbf_call<float,5>, "rbf xy 5 dim float");
    m.def("rbf float 5", &rbf_call<float,4>, "rbf xy 4 dim float");
    m.def("rbf float 5", &rbf_call<float,3>, "rbf xy 3 dim float");
    m.def("rbf float 5", &rbf_call<float,2>, "rbf xy 2 dim float");
    m.def("rbf float 5", &rbf_call<float,1>, "rbf xy 1 dim float");
