CUDA_VISIBLE_DEVICES=0 python experiments_2.py --idx=1 &>> experiment_2_uniform.out
...
CUDA_VISIBLE_DEVICES=6 python experiments_2.py --idx=5 &>> experiment_2_data.out
