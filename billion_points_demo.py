...
if __name__ == '__main__':
    n=100000000 #Nr of observations
    ...
    Y=torch.clone(X[0:500000,:])
    b_2 = torch.randn(500000,1).float().to(device) #weights
    ...
    true_1 = keops_benchmark_1@b_2 #calculate reference
