...
if __name__ == '__main__':
    n=1000000000 #Nr of observations
    ...
    min_points = float(10000) # stop when dividing when the largest box has 1000 points
    ...
    rel_err_0 = calc_rel_error(true_res=true_0,approx_res=res_1[:ref_points])
